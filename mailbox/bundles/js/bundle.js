...
Elm.Bundle = Elm.Bundle || {};
Elm.Bundle.make = function (_elm) {
   "use strict";
   _elm.Bundle = _elm.Bundle || {};
   if (_elm.Bundle.values)
   return _elm.Bundle.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   greeting) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("container gutter")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("row")]),
      _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-1")]),
                   _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.id("1")
                                ,$Html$Attributes.$class("inner app phone no-placeholder")]),
                   _L.fromArray([A2($Html.div,
                                _L.fromArray([A2($Html$Events.onClick,
                                address,
                                "Hello!")]),
                                _L.fromArray([$Html.text("Click for English")]))
                                ,A2($Html.p,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(greeting)]))]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-1")]),
                   _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.id("2")
                                ,$Html$Attributes.$class("inner app phone no-placeholder")]),
                   _L.fromArray([A2($Html.div,
                                _L.fromArray([A2($Html$Events.onClick,
                                address,
                                "Salut!")]),
                                _L.fromArray([$Html.text("Click for French")]))
                                ,A2($Html.p,
                                _L.fromArray([]),
                                _L.fromArray([$Html.text(greeting)]))]))]))]))]));
   });
